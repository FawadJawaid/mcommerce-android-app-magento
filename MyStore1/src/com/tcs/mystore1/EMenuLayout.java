...
public class EMenuLayout extends LinearLayout {
    ...
    */
    ...
    public EMenuLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public EMenuLayout(Context context) {
        super(context);
    }
    ...
    protected void onAttachedToWindow() {
        ...
        content.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                return EMenuLayout.this.onContentTouch(v, event);
            }
        });
